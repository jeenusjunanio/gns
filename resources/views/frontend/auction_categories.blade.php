...
@section('content')
<section class="banner bg-banner-one overlay" style='background-image: url("{{asset('/frontend/hero/Mask_Group_1@2x.png')}}");'>
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <!-- Content Block -->
...
<section id="" class="ltst_auction">
  <div class="container">
    <div class="row">
        ...
        @if($auction)
        <div class="col-lg-8">
            <h6 class="auctitle">Latest Auctions Under <b class="text-uppercase text-danger"><i>{{$category->cat_name}}</i></b></h6>
            ...
            <div class="row">
              <div class="container latest_auc_title">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="row">
                        <label class="auc_title_label" for="time">Time left:</label>
  ...
  <section id="prev-auction">
    <div class="container">
      <div class="row">
        <h6>Previous Auction Under <b class="text-uppercase text-danger"><i>{{$category->cat_name}}</i></b></h6>
        <div class="swiper-container medal-slide">
          <div class="swiper-wrapper">
            @foreach($auctions as $old_auction)
            <div class="col-md-4 medal-box swiper-slide">
              <a href="{{url('auction-lot/'.$old_auction->id.'/lots')}}" class="row">
                <div class="prev-auc-left">
                  <img src="{{getimg($old_auction->image)}}" alt="medal" class="" height="auto" width="100%">
                </div>
