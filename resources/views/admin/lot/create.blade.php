...
<section class="content">
  <div class="container-fluid">
    <div class="card card-dark border-dark">
      ...
      <!-- /.card-header -->
      <div class="card-body">
        <form action="{{route('admin_lot.store')}}" class="" method="post" enctype="multipart/form-data">
          @csrf
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <select class="form-control select2bs4 " data-dropdown-css-class="select2-danger" style="width: 100%;" name="auction">
                  ...
                  <option value="{{$auction->id}}" {{old('auction')==$auction->id?'selected':''}}>Auction No. {{$auction->auction_number}}</option>
                  @endforeach
                </select>
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label>Lot No</label>
                <input type="text" class="form-control" value="{{old('lot_number')}}" name="lot_number">
          ...
          <div class="row">
            <div class="col-md-2">
              <input type="submit" class="form-control btn btn-success" value="Create lot" />
            </div>
          </div>
