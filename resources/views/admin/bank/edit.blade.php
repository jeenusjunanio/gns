      ...
      <div class="container-fluid">
        ...
        <div class="card card-dark border-dark">
          <div class="card-header bg-navy">
            <h3 class="card-title">Edit <b class="text-warning"><i>{{$bank->name}}</i></b>&nbsp;&nbsp;Bank Detail</h3>
            ...
            <form action="{{route('bank.update',$bank->id)}}" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" id="summernote" placeholder="Enter ..." name="bank_info">{{old('bank_info')?old('bank_info'):$bank->bank_info}}</textarea>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" id="summernote1" placeholder="Enter ..." name="bank_description">{{old('bank_description')?old('bank_description'):$bank->bank_description}}</textarea>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{old('name')?old('name'):$bank->name}}" name="name">
              ...
              <div class="row">
                <div class="col-md-3">
                  ...
                  <div class="form-group">
                    <img src="{{getimg($bank->qr_code)}}" alt="">
                  </div>
                </div>
                <div class="col-md-3">
                    <label>Old Logo</label>
                  <div class="form-group">
                    <img src="{{getimg($bank->bank_logo)}}" alt="">
                  </div>
                </div>
              </div>
              <div class="row">
