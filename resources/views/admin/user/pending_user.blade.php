        ...
        <div class="col-12">
          <div class="card card-navy border-dark">
            <div class="card-header">
              <h3 class="card-title">All Pending Users</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <tbody>
                  ...
                  @endphp
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{route('approve_user',$user->id)}}" class="bg-success p-2 ">Approve</a>
                        <form id="deletecat{{ $user->id }}" action="{{route('user.destroy',$user->id)}}" method="post" style="display: inline;">
                            @csrf
                            @method('DELETE')
                           <a href="javascript:void(0)" data-id="{{ $user->id }}" class="delete-confirm bg-danger p-2">Decline</a>
                        </form>
