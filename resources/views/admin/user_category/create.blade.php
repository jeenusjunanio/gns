                  ...
                  <form action="{{route('user_category.store')}}" method="post" >
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control {{$errors->has('name')? ' border-danger':''}}" id="name" placeholder="Enyter Category Name" value="{{old('name')}}" name="name" required>
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="text" class="form-control {{$errors->has('bid_limit')? ' border-danger':''}}" id="bid_limit" placeholder="Enyter Bid Limit" value="{{old('bid_limit')}}" name="bid_limit" required>
