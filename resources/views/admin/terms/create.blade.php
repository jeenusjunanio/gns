        ...
        <div class="card card-dark border-dark">
          ...
          <div class="card-body">
            <form action="{{route('terms.store')}}" method="post">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" id="summernote" placeholder="Enter ..." name="detail">{{old('detail')}}</textarea>
              ...
              <div class="row">
                <div class="col-md-2">
                      <input type="submit" class="form-control btn bg-navy" value="Add Terms" />
                </div>
              </div>
